...
import themes from '@/module/Painel/lib/themes';
            ...
            <form onSubmit={handleSubmit}>
                <div className="grid gap-6">
                        ...
                        <div className="card-body">
                            <div className="mb-4">
                                ...
                                <p className="text-sm text-gray-500">
                                    Esta imagem será exibida como logo da sua empresa.
                                </p>
                            </div>
                            <div className="flex flex-col md:flex-row items-center gap-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-gray-500 text-center">
                                        JPG, PNG ou Webp. Tamanho máximo de 3MB.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="card-body space-y-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <div>
                                        <label className="input w-full">
                                            <FaMapSigns size={18} className="text-primary" />
                                            <input
                                                id="cidade"
                                                name="cidade"
                                                type="text"
                                ...
                                <div>
                                    ...
                                    <div>
                                        <label className="input w-full">
                                            <TbFileDescription size={18} className="text-primary" />
                                            <input
                                                id="descricao"
                                                name="descricao"
                                                type="text"
                                ...
                                <div>
                                    <label htmlFor="maps" className="label">
                                        <span className="label-text flex items-center flex-row gap-2">
                                            ...
                                            <FaQuestionCircle
                                                ...
                                                onClick={() =>
                                                    (
                                                        document.getElementById('modal_maps')! as HTMLDialogElement
                                                    ).showModal()
                                                }
                                            />
                                        </span>
                                    ...
                                    <p className="text-xs text-gray-500">
                                        Cole aqui o link do Google Maps para sua localização.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="card-body space-y-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <div>
                                        <label className="input">
                                            <FaUserSecret size={18} className="text-primary" />
                                            <input
                                                id="senha"
                                                name="senha"
                                                type="text"
                    ...
                    <div className="card bg-base-100 shadow-md">
                        <div className="card-body">
                            <div className="mb-4">
                                ...
                                <p className="text-sm text-gray-500">
                                    Escolha um tema para personalizar a aparência da sua loja.
                                </p>
                            </div>
                    ...
                    <div className="flex justify-center">
                        <button type="submit" className="btn p-5 btn-primary">
                            Salvar Alterações
                        </button>
                    </div>
                </div>
            </form>
            <dialog id={'modal_maps'} className="modal">
                <div className="modal-box">
                    <h3 className="font-bold text-lg text-center">
                        Como eu consigo o link do google maps para minha pagina?
                    </h3>
                    <div className="py-4">
                        <ul>
