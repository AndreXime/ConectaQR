        ...
        <main className="flex-grow py-5 md:px-3 flex flex-col justify-center gap-4">
            <div className="mb-4">
                ...
                <p className="text-gray-500">
                    Crie e personalize o QR Code da sua loja para compartilhar com seus clientes.
                </p>
            </div>
                        ...
                        {qrTab === 'avancado' && (
                            <div className="mb-auto">
                                ...
                                <p className="text-xs text-gray-500 mt-1">
                                    Níveis mais altos de correção permitem que o QR Code seja lido mesmo se estiver
                ...
                <div className="card bg-base-100 shadow-xl min:h-150">
                    <div className="card-body items-center">
                        ...
                        <p className="text-sm text-gray-500 mt-4 text-center">
                            Escaneie este QR Code para acessar sua loja online
                        </p>
                    </div>
            ...
            <div className="card bg-base-100 shadow-xl">
                <div className="card-body">
                    ...
                    <div className="grid gap-4 md:grid-cols-3">
                        <div className="border rounded-md p-4">
                            ...
                            <p className="text-sm text-gray-500">
                                Imprima seu QR Code em materiais promocionais, cartões de visita, cardápios ou na
                                vitrine da sua loja física.
                            </p>
                        </div>
                        <div className="border rounded-md p-4">
                            <h3 className="font-medium mb-2">Redes Sociais</h3>
                            <p className="text-sm text-gray-500">
                                Compartilhe seu QR Code nas redes sociais para que seus seguidores possam acessar sua
                                loja online.
                            </p>
                        </div>
                        <div className="border rounded-md p-4">
                            ...
                            <p className="text-sm text-gray-500">
                                Inclua o QR Code em suas campanhas de email marketing para direcionar os clientes para
                                sua loja.
                            </p>
                        </div>
                    </div>
                    <div className="bg-gray-200 p-4 rounded-md mt-4">
                        <p className="text-sm">
                            <strong>Dica:</strong> Sempre teste seu QR Code antes de distribuí-lo para garantir que ele
            ...
            <div className="hidden">
                <fieldset className="fieldset text-center text-xl font-bold mb-3">
                    ...
                    <select onChange={handleSwitch} defaultValue={currentQr.title} className="select w-full font-bold">
                        {QRcodes.map((qr) => (
                            <option key={qr.title}>{qr.title}</option>
                        ))}
                    </select>
                ...
                <div className="flex flex-col justify-center items-center">
                    <QRCodeCanvas fgColor="blue" ref={canvasRef} value={currentQr.link} size={qrSize} />
                    <button onClick={downloadQRCode} className="btn btn-primary mt-4 w-full">
