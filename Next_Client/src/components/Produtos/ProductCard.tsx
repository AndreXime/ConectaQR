...
export default function ProductCard({ name, image, price, className }: ProductCardProps) {
	return (
		<div className={'bg-base-100 rounded-xl h-85' + className}>
			<div className="w-full h-55 p-4 overflow-hidden flex items-center justify-center select-none pointer-events-none">
				<Image
					width={500}
					height={500}
					src={image}
			...
			<div className="p-4 px-3">
				...
				<h6 className="font-semibold md:text-lg mt-3">R$ {price}</h6>
			</div>
		</div>
	);
}
